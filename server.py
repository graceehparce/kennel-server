...
from repository import RESOURCES
...
method_mapper = {
    "animals": {
        "all": all(RESOURCES["animals"]),
        "single": retrieve(id, RESOURCES["animals"])
    },
    "locations": {
        "all": all(RESOURCES["locations"]),
        "single": retrieve(id, RESOURCES["locations"])
    },
    "employees": {
        "all": all(RESOURCES["employees"]),
        "single": retrieve(id, RESOURCES["employees"])
    },
    "customers": {
        "all": all(RESOURCES["customers"]),
        "single": retrieve(id, RESOURCES["customers"])
    },
}
